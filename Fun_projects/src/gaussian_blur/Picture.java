...
import java.awt.image.BufferedImage;
	...
	/**
	 * The Picture class wraps a BufferedImage providing methods that allow
	for
	 * access to individual pixel component values as well as selected
	methods
...
public class Picture {
	...
	*/
     ...
     * Constructor
     *
     * @param image The image supplied by the user to modify
     */
    public Picture(BufferedImage image) {
        this.image = image;
    }
    /**
     * Isolates the magnitude of the red component of a pixel at
coordinates
     * (x, y) from the image provided to the constructor. May throw an
     * ArrayOutOfBoundsException if the given coordinates are not
within the
     * bounds of the image.
     *
    ...
    /**
     * Isolates the magnitude of the green component of a pixel at
coordinates
     * (x, y) from the image provided to the constructor. May throw an
     * ArrayOutOfBoundsException if the given coordinates are not
within the
    ...
    /**
     * Isolates the magnitude of the blue component of a pixel at
coordinates
     * (x, y) from the image provided to the constructor. May throw an
     * ArrayOutOfBoundsException if the given coordinates are not
within the
    ...
    /**
     * Sets the RGB value of a pixel at the given (x, y) coordinates to
the
     * given RGB value. May throw an ArrayOutOfBoundsException if the
given
     * coordinates are not  within the bounds of the image.
     *
     * @param x The x-coordinate of the image
     * @param y The y-coordinate of the image
     * @param rgb The RGB value to set this pixel
     */
